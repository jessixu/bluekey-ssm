				...
				<div class="tabbable" id="tabs-368872">
					...
					<div class="tab-content">
						<div class="tab-pane fade in active" id="panel-detail">
							<div class="row clearfix">
								<div class="col-md-12 column">
									<form class="form-horizontal" id="access_form"  role="form" >
										<div class="form-group">
											...
											<div class="col-sm-4">
												<select class="form-control " name="parentPart">
													<option value="1" selected>general access</option>
													<option value="2"  >function access</option>
												</select>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control input" name="shortTitle" />
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<textarea class="form-control  input" name="function" rows="6"></textarea>
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												 <input type="radio" name="platform" value="1"  checked>lotus notes &nbsp;&nbsp;&nbsp;
									             <input type="radio" name="platform" value="2" >web
											</div>
										</div>				
										<div class="form-group">
											 <label for="inputURL" class="col-sm-2 control-label">URL</label>
											<div class="col-sm-8">
												<input type="url" class="form-control input" name="url"  placeholder="http://"/>
											</div>
										</div>
										<div class="form-group">
											 <label for="inputURL" class="col-sm-2 control-label">URL 2</label>
											<div class="col-sm-8">
												<input type="url" class="form-control input" name="otherUrl"  placeholder="http://"/>
											</div>
										</div>
										<div class="form-group">
											 <label for="inputURL" class="col-sm-2 control-label">Access email</label>
											<div class="col-sm-8">
												<input type="email" class="form-control input" name="applyEmail"  placeholder="XXXXX@cn.ibm.com"/>
											</div>
										</div>
										<div class="form-group">
											 <label for="inputURL" class="col-sm-2 control-label">Lead time</label>
											<div class="col-sm-2">
												<input type="number" class="form-control input" name="leadTime"  />
											</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<textarea class="form-control  input" name="applyStep" rows="12"></textarea>
											</div>
										</div>
										<div class="form-group">
											<div class="col-sm-offset-2 col-sm-10">
												 <button  class="btn btn-primary" id="access-btn" style="background: #5C7EBD; border: 0;">Save</button>
											</div>
										</div>
									</form>
								</div>
									...
									<form  id="email_form" class="form-horizontal" role="form" >
										...
										<div class="form-group">
											<div class="col-sm-offset-2 col-sm-10">
												 ...
												 <button  type="button" id="email-btn" class="btn btn-primary" style="background: #5C7EBD; border: 0;">Save</button>
											</div>
										</div>
									</form>
								</div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
		    ...
		    $("#email-btn").click(function() {
		    	var mailValidator  = $("#email_form").data("bootstrapValidator");
